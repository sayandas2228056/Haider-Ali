...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      secondary: "Cloud , Cybersecurity ,Telecom Services , IT Services , Software Liscense, Software Development",      action: "https://www.zenitech.in",
