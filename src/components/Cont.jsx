...
import { MessageCircle, Mail, Phone, Plus, X, Globe } from 'lucide-react';
...
const Cont = () => {
  ...
  const handleEmail = () => {
    const email = 'haider@zenitech.in';
  ...
  const handleWeb = () => {
    const website = 'https://www.zenitech.in';
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 md:bottom-6 md:right-6">
      ...
      >
        {[
          { icon: <Globe size={22} />, label: 'Website', onClick: handleWeb },
